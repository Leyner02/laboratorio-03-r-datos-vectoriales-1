...
```{r}
ggplot(centro_america, aes(x=reorder(iso_a2, -lifeExp), y=lifeExp)) +
   ggtitle("Esperanza de vida en los países de Centroamérica.") +
...
```{r}
plot(centro_america["lifeExp"], main="Esperanza de vida en los países Centroaméricanos. ")
```
